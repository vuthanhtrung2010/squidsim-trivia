...
module.exports = async (client, message) => {
  try {
    ...
    if (!(message.guild.id === "901533988382998618" || message.guild.id === "1220234130634178591")) {
      return message.channel.send({ content: "You can only use commands in SquidSim a.k.a [SuS Nation](https://discord.gg/squidsim)" });
    }
